...
const { obtenerProductos,obtenerProductoByID, crearProducto, editarProducto, eliminarProducto } = require('../controllers/productos');
const { ProductoExisteById, validacionCategoria } = require('../helpers/db-validators');
